@echo off
REM Lance l'instance CLIENT pour tester le multijoueur
REM Cette version fonctionne SANS Maven

title BacLegend - CLIENT
color 0B

echo.
echo ===================================================
echo    INSTANCE CLIENT
echo ===================================================
echo.
echo Instructions:
echo   1. Une fenetre JavaFX va s'ouvrir
echo   2. Cliquez sur "Jouer en Multijoueur"
echo   3. Verifiez que l'IP est "127.0.0.1"
echo   4. Cliquez sur "Rejoindre"
echo.
